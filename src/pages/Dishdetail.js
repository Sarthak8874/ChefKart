    ...
    <>
      <section className="dishdetail">
        <div className="flex justify-center w-full">
          <div className="h-[650px] w-[350px] mt-10 overflow-hidden ">
            <div className="relative w-[350px] h-[190px] px-5 bord-er">
              ...
              <div className="time flex mt-8 ">
                <img src={Time} className="h-3 w-3 mr-2" />
              ...
              <div>
                <img
                  src={veg2}
                  className="w-[321px] h-[130px] absolute bottom-[-60px] right-[-130px]"
                />
              </div>
            </div>
            <div className="flex  ml-[16px] h-[80px] w-[300px] bord-er">
              <div
            ...
            <div className="flex flex-col  ml-[16px] h-[110px] w-[300px]">
              <div
              ...
              {dishdetail?.ingredients?.vegetables.map(({ name, quantity }) => {
                return (
                  <>
                    <div className="flex w-full justify-between list px-2 my-1">
                      <div>{name}</div>
                      <div>{quantity}</div>
                    </div>
                  </>
            ...
            <div className="flex flex-col  ml-[16px] h-[85px] w-[300px]">
              <div
                className="heading flex"
                style={{ fontSize: "16px", width: "200px" }}
              >
                ...
                {dishdetail?.ingredients?.appliances.map(({ name, image }) => {
                  return (
                    <div className="items flex flex-col justify-center items-center mx-2">
                      <img src={Refrigerator} className="w-[30px] h-[55px]" />
